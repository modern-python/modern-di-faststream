...
├── CONTEXT.md
├── docs/adr/
│   ├── 0001-keep-dimiddlewarefactory.md
│   └── 0002-install-middleware-on-startup.md
└── modern_di_faststream/
```
...
> _Contradicts ADR-0001 (keep dimiddlewarefactory), but worth reopening because…_
