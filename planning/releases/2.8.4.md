# modern-di-faststream 2.8.4 — release pipeline on PyPI Trusted Publishing

No library changes. The package is identical to 2.8.3; this release exercises the new publish path end-to-end.
